...
CREATE TABLE `inventorydetails` (
  ...
  `ID_ProductID` int(11) NOT NULL,
  `ID_ProductQuantity` int(11) NOT NULL,
  PRIMARY KEY (`ID_Id`),
  KEY `ID_ProductID` (`ID_ProductID`),
  CONSTRAINT `inventorydetails_ibfk_1` FOREIGN KEY (`ID_ProductID`) REFERENCES `productdetails` (`PD_ProductId`)
...
-- Dump completed on 2017-08-13  1:03:47
