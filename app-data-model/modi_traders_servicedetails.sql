...
CREATE TABLE `servicedetails` (
  `SD_ServiceId` int(11) NOT NULL AUTO_INCREMENT,
  `SD_ServiceType` varchar(20) NOT NULL,
  `SD_StartDate` date NOT NULL,
  `SD_CREATION_TIMESTAMP` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `SD_MODIFICATION_TIMESTAMP` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`SD_ServiceId`)
