...
CREATE TABLE `consignee_details` (
  ...
  `CONSIGNEE_ADRESS` varchar(500) NOT NULL,
  `CONSIGNEE_STATE` varchar(100) DEFAULT NULL,
  `CONSIGNEE_STATE_CODE` varchar(5) DEFAULT NULL,
  `CONSIGNEE_GSTIN` varchar(100) DEFAULT NULL,
  `CONSIGNEE_EMAIL` varchar(50) DEFAULT NULL,
  `CONSIGNEE_MOBILE` varchar(13) DEFAULT NULL,
  `CONSIGNEE_PHONE` varchar(13) DEFAULT NULL,
  `CONSIGNEE_CREATIONTIMESTAMP` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `CONSIGNEE_MODIFICATIONTIMESTAMP` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
